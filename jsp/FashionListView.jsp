...
<%@page import="in.co.online.fashion.controller.FashionListCtl"%>
<%@page import="com.sun.xml.internal.bind.v2.util.FatalAdapter"%>
...
<div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"> <strong class="text-black">Clothes List</strong></div>
        </div>
      </div>
    </div>
              ...
              <table class="table table-bordered">
                ...
                <tbody>
                   ...
                   <%
							...
							Iterator<ClothesBean> iterator=list.iterator();
				...
				%>
                  <tr>
                    ...
                    <td><a href="ClothesCtl?id=<%=bean.getId()%>" class="btn btn-primary btn-sm">Edit</a></td>
                    <td><a href="FashionListCtl?faId=<%=bean.getId()%>" class="btn btn-primary btn-sm">X</a></td>
                  </tr>
            ...
            <div class="row mb-5">
              ...
              <div class="col-md-6 mb-3 mb-md-0">
                <input type="submit" name="operation"
						value="<%=FashionListCtl.OP_PREVIOUS%>" class="btn btn-primary btn-sm btn-block" <%=(pageNo==1)? "disabled" : "" %>>
              </div>
              <div class="col-md-6">
               <%ClothesModel model=new ClothesModel(); %>
               <input type="submit" name="operation"
						value="<%=FashionListCtl.OP_NEXT%>" class="btn btn-primary btn-sm btn-block" <%=((list.size()<pageSize)||model.nextPK()-1==bean.getId())? "disabled": "" %>>
              </div>
            </div>
