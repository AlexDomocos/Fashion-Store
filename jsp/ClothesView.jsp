<%@page import="in.co.online.fashion.controller.ClothesCtl"%>
<%@page import="in.co.online.fashion.util.HTMLUtility"%>
...
<%@ include file="Header.jsp" %>
 <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.html">Welcome</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Add Clothes</strong></div>
        </div>
      </div>
    </div>  
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Add CLothes</h2>
            
          </div>
          <div class="col-md-7">
			
            <form action="<%=OFSView.CLOTHES_CTL%>" method="post" enctype="multipart/form-data" >
            
            <jsp:useBean id="bean" class="in.co.online.fashion.bean.ClothesBean"
               ...
               <div class="form-group row">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    ...
                    <input type="text" class="form-control"  name="name" placeholder="Enter Clothes Name" 
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    ...
                    <input type="text" class="form-control"  name="price" placeholder="Enter Clothes Price" 
                ...
                <div class="form-group row">
                  <div class="col-lg-6">
                    <input type="submit" class="btn btn-primary btn-lg btn-block" name="operation" value="<%=ClothesCtl.OP_SAVE%>">
                  </div>
                  <div class="col-lg-6">
                    <input type="submit" class="btn btn-primary btn-lg btn-block" name="operation" value="<%=ClothesCtl.OP_RESET%>">
                  </div>
                </div>
              </div>
            </form>
