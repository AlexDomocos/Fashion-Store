<%@page import="in.co.online.fashion.controller.UserRegistrationCtl"%>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-7">
            ...
            <form action="<%=OFSView.USER_REGISTRATION_CTL%>" method="post">
            
            <jsp:useBean id="bean" class="in.co.online.fashion.bean.UserBean"
