package in.co.online.fashion.util;
...
import in.co.online.fashion.controller.BaseCtl;
import in.co.online.fashion.controller.OFSView;
...
public class ServletUtility {
	...
	public static void handleException(Exception e, HttpServletRequest request, HttpServletResponse response)
		...
		ServletUtility.forward(OFSView.ERROR_CTL, request, response);
		e.printStackTrace();
	}
