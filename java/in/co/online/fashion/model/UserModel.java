...
import in.co.online.fashion.exception.RecordNotFoundException;
import in.co.online.fashion.util.EmailBuilder;
import in.co.online.fashion.util.EmailMessage;
import in.co.online.fashion.util.EmailUtility;
...
public class UserModel {
	...
	public Integer nextPK() throws DatabaseException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement("SELECT MAX(ID) FROM F_USER");
	...
	public long add(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement("INSERT INTO F_USER VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)");
			pstmt.setInt(1, pk);
	...
	public UserBean findByLogin(String login) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer("SELECT * FROM F_USER WHERE LOGIN=?");
		UserBean bean = null;
		Connection conn = null;
	...
	public UserBean findByPK(long pk) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer("SELECT * FROM F_USER WHERE ID=?");
		UserBean bean = null;
		Connection conn = null;
	...
	public void update(UserBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE F_USER SET FIRSTNAME=?,LASTNAME=?,LOGIN=?,PASSWORD=?,DOB=?,MOBILENO=?,ROLEID=?,gender=?,"
	...
	public List search(UserBean bean, int pageNo, int pageSize) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer("SELECT * FROM F_USER WHERE 1=1");
	...
	public List list(int pageNo, int pageSize) throws ApplicationException {
		...
		ArrayList list = new ArrayList();
		StringBuffer sql = new StringBuffer("select * from F_USER");
		// if page size is greater than zero then apply pagination
		if (pageSize > 0) {
			// Calculate start record index
			pageNo = (pageNo - 1) * pageSize;
	...
	public UserBean authenticate(String login, String password) throws ApplicationException {
		...
		StringBuffer sql = new StringBuffer("SELECT * FROM F_USER WHERE LOGIN = ? AND PASSWORD = ?");
		UserBean bean = null;
		Connection conn = null;
